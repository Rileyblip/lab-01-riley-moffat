...
The data frame has 1846 rows with 3 variables called **dataset**, **x**, and **y**.
...
The correlation coefficient for `star` is **-0.0630**, greater than the correlation coefficient for `dino`.
...
The correlation coefficient for `circle` is **-0.0683**, less than the correlation coefficient for `dino`.
